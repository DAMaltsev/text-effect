                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        ...
                        (B = document.getElementById("__main")),
                          ...
                          switch ((o.prev = o.next)) {
                            ...
                            case 19:
                              if (
                                ...
                                (n = L(
                                  k(M(n) ? I(n) : n, a.locale, c.defaultLocale)
                                )),
                              ...
                              return (
                                (_ = w.parseRelativeUrl(
                                  v.normalizeLocalePath(
                                    M(b.rewrite) ? I(b.rewrite) : b.rewrite,
                                    t.locales
                                  ).pathname
                                )),
                                (S = p.removePathTrailingSlash(_.pathname)),
                                e.pages.includes(S)
                                  ? ((P = !0), (x = S))
                                  : (x = W(S, e.pages)) !== _.pathname &&
                                    e.pages.includes(x) &&
                                    (P = !0),
                                r.abrupt("return", {
                                  type: "rewrite",
                            ...
                            case 54:
                              ...
                              return (
                                (O = p.removePathTrailingSlash(
                                  v.normalizeLocalePath(
                                    M(b.redirect) ? I(b.redirect) : b.redirect,
                                    t.locales
                                  ).pathname
                                )),
                                (R = U(t, O, O)),
